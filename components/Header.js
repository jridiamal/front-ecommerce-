...
const StyledHeader = styled.header`
  ...
  /* Sur mobile on garde un fond semi-transparent pour la lisibilité */
...
const Wrapper = styled.div`
  ...
  align-items: center;
  padding: 12px 0; /* Padding réduit sur mobile */
...
const MobileBottomNav = styled.nav`
  ...
  z-index: 1000;
  /* Gère la "Safe Area" des iPhones récents sans bouton physique */
...
const MobileNavItem = styled(Link)`
  ...
  flex: 1; /* Chaque item prend la même place */
  ...
  /* Effet visuel au clic sur mobile */
  &:active {
